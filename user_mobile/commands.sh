...
solana-keygen new --outfile /home/pentec/mint_cycle/create_dynamic_nft/user_mobile/Owner.json
...
solana-keygen new --outfile /home/pentec/mint_cycle/create_dynamic_nft/user_mobile/Creator.json

solana config set --keypair /home/pentec/mint_cycle/create_dynamic_nft/user_mobile/Owner.json
...
./sugarCM3 upload
# Candy machine ID: xoHu51ZiYBPLWvv3KBtRtCY8cr4vnMfvN81g5Da8FKk
# Collection mint ID: AY1uSDu6Ndmre8CeHBJmsn75GiNLTCncSXY2Sd3sbKZh
./sugarCM3 deploy
