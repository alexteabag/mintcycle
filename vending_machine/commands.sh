...
solana-keygen new --outfile /home/pentec/mint_cycle/create_dynamic_nft/mc_application/Owner.json
...
solana-keygen new --outfile /home/pentec/mint_cycle/create_dynamic_nft/mc_application/Creator.json

solana config set --keypair /home/pentec/mint_cycle/create_dynamic_nft/mc_application/Owner.json
...
./sugarCM3 upload
# Candy machine ID: BNRJtE638KXCiR3QKbPbxiV8dCdTtFtyVyV5WoUKq7kn
# Collection mint ID: HcPehSjMnqFuEZHsfz447takG3tHp4zqvpCecapasFey
./sugarCM3 deploy
